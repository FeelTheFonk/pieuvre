...
- **CI/CD Hardening**: Improved GitHub Actions workflows, added `cargo-deny` for security auditing, migrated configuration to v0.18+ standards, and resolved license conflicts (GPL-3.0 literal, Unicode-3.0).
